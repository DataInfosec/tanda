 ...
 *
 * DESCRIPTION:
 *     Android Java wrapper for IBScanUltimatePI library
...
public class IBScanDevice
{
 ...
 /**
    ...
    */
     ...
     * @throws IBScanException
     */
    public int SaveBitmapImage(ImageData image, String filename) throws IBScanException
    {
        final NativeError   error    = new NativeError();
        final int       nRC = SaveBitmapImageNative(image, filename, error);
        handleError(error); // throws exception if necessary
	...
	*/
    ...
    private native void setUsbStreamNative(int start);
	...
	/* Native method for SaveBitmapImageNative(). */
	private native int SaveBitmapImageNative(ImageData image, String filename, NativeError error);
    ...
    public void setUsbStream(boolean start){
        if(start){
            setUsbStreamNative(1);
        }else {
            setUsbStreamNative(0);
        }
    }
