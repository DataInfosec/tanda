...
{	
    ...
    private static UsbDevice findDevice(int deviceId)
    {
    	...
    	//Log.e("open","findDevice deviceId" + deviceId);
    ...
    protected static int openDevice(int deviceId)
    {
		...
		//	Log.e("open","m_context != null");
			...
			//	Log.e("open","device != null");
				...
				//		Log.e("open","connection open deviceId " + deviceId + " fd " + fd);
    	...
    	if (m_context != null)
    	{
    		...
    		if (connection != null)
    		{
    			/* Close connection and remove from map. */
	   			connection.close();
	   			//Log.e("close","connection close " + deviceId);
